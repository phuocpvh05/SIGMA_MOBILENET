...
//   0x0024 CLOCK_HZ R configured PL clock frequency (250,000,000)
//   0x0028 PROFILE  R implementation profile/version ("MOB7")
        ...
        if (!s_axi_aresetn) begin
            ...
            if (s_axi_arvalid && s_axi_arready) begin
                ...
                case (s_axi_araddr)
                    ...
                    16'h0024: s_axi_rdata <= 32'd250000000;
                    // MOB7 is the board-proven, bit-exact 64-PE datapath.
                    // A new profile prevents software from benchmarking a
                    // stale MOB4/MOB5/MOB6 fast-engine bitstream.
                    16'h0028: s_axi_rdata <= 32'h4d4f4237;
