...
foreach ($name in @("mobilenet_onchip_bf16_wide.mem",
    "mobilenet_onchip_bf16_bank0.mem", "mobilenet_onchip_bf16_bank1.mem",
    "mobilenet_onchip_bf16_bank2.mem", "mobilenet_onchip_bf16_bank3.mem")) {
    Copy-Item (Join-Path $model $name) (Join-Path $build $name) -Force
}
...
$image0 = Join-Path $PSScriptRoot "images\mnist_0\image_bf16.mem"
$image1 = Join-Path $PSScriptRoot "images\mnist_1\image_bf16.mem"
